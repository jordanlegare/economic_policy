...
- **Zero-deficit objective:** the strategy score adds a bounded reward for shrinking the bilateral balance toward zero, while the positive-growth guardrail remains binding. Since one country's bilateral surplus is the other's deficit after currency conversion, the shared absolute balance is the relevant win-win target rather than two independently manipulable deficit measures.
