...
- **Live bilateral negotiation rooms:** persistent header tabs open dedicated Canada/LeBlanc and USA/Greer workspaces where each party can set its headline position and tariff coverage across all 20 sectors. Every change is synchronized with the joint dashboard, reruns the full economy, and publishes the leading compromise to both rooms.
